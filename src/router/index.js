...
const Submission = () =>
  import(/* webpackChunkName: "status" */ "../views/Submission.vue");
const Judger = () =>
  import(/* webpackChunkName: "about" */ "../views/Judger.vue");
const Faq = () => import(/* webpackChunkName: "about" */ "../views/Faq.vue");
const OIRank = () =>
  import(/* webpackChunkName: "rank" */ "../views/OIRank.vue");
const ACMRank = () =>
  import(/* webpackChunkName: "rank" */ "../views/ACMRank.vue");
const Setting = () =>
...
const Contest_Home = () =>
  import(/* webpackChunkName: "contest" */ "../views/Contest/Home.vue");
const Contest_ProblemList = () =>
  import(/* webpackChunkName: "contest" */ "../views/Contest/ProblemList.vue");
const Contest_Problem = () =>
  import(/* webpackChunkName: "contest" */ "../views/Contest/Problem.vue");
const Contest_StatusList = () =>
  import(/* webpackChunkName: "contest" */ "../views/Contest/Status.vue");
const Contest_Rank = () =>
  import(/* webpackChunkName: "contest" */ "../views/Contest/Rank.vue");

const Setting_Profile = () =>
  import(/* webpackChunkName: "setting" */ "../views/Setting/Profile.vue");
const Setting_Account = () =>
  import(/* webpackChunkName: "setting" */ "../views/Setting/Account.vue");
const Setting_Security = () =>
  import(/* webpackChunkName: "setting" */ "../views/Setting/Security.vue");

const Admin_General = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/General.vue");
const Admin_Users = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/Users.vue");
const Admin_Announce = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/Announce.vue");
const Admin_Config = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/Config.vue");
const Admin_JudgeServer = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/JudgeServer.vue");
const Admin_PruneTestcase = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/PruneTestcase.vue");
const Admin_Problem = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/Problem.vue");
const Admin_ContestList = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/ContestList.vue");
const Admin_Contest = () =>
  import(/* webpackChunkName: "admin" */ "../views/Admin/Contest.vue");
