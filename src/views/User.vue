                ...
                <div class="card-body">
                    <div class="text-center pt-5">
                        <p>
                            ...
                            <br>
                            <span class="badge bg-danger" v-if="profile.data.user.admin_type == 'Super Admin'">Super Admin</span>
                            <span class="badge bg-danger" v-if="profile.data.user.admin_type == 'Admin'">Admin</span>
                        </p>
