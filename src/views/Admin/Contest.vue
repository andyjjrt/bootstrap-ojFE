  ...
  <div v-if="contest">
    <div class="card card-body">
      ...
      <div class="row g-3" v-if="contest">
        ...
        <div class="col-sm-4">
          <DatePicker
            v-model="contest.data.start_time"
            mode="dateTime"
          ...
          <div>
            <div class="form-check form-check-inline">
              <input
                ...
                id="rule_acm"
                value="ACM"
                v-model="contest.data.rule_type"
                disabled
              />
        ...
        <div class="col-sm-4">
          ...
          <div class="form-check form-switch">
            <input
              ...
              type="checkbox"
              id="ContestRTR"
              v-model="contest.data.real_time_rank"
            />
        ...
        <div class="col-sm-6">
          ...
          <div
            ...
            role="alert"
            v-for="ips in contest.data.allowed_ip_ranges"
            :key="ips"
          >
            {{ ips }}
            <button
              ...
              aria-label="Close"
              @click="
                contest.data.allowed_ip_ranges.splice(
                  contest.data.allowed_ip_ranges.indexOf(ips),
                  1
                )
              "
            ></button>
        ...
        <div class="col-sm-12">
          <button class="btn btn-primary float-end" @click="save_contest">
            Save
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
      ...
      this.$http
        .get(
          window.location.origin +
            ...
            this.$route.params.manage_contest_id
        )
        .then((response) => {
    ...
    save_contest() {
      ...
      this.contest.data.start_time = new Date(
        this.contest.data.start_time
      ).toISOString();
      this.contest.data.end_time = new Date(
        this.contest.data.end_time
      ).toISOString();
      this.$http
        .put(window.location.origin + "/api/admin/contest", this.contest.data)
        .then((response) => {
