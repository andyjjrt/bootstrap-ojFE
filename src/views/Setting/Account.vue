      ...
      <div class="col-md">
        ...
        <form action="#" @submit.prevent="change_pass()">
          ...
          <button
            ...
            :class="{ disabled: change_pass_btn }"
          >
            Change
          </button>
        </form>
      ...
      <div class="col-md">
        ...
        <form action="#" @submit.prevent="change_email()">
          ...
          <button
            type="submit"
            class="btn btn-primary"
            :class="{ disabled: change_email_btn }"
          >
            Change
          </button>
        </form>
...
export default {
  ...
  methods: {
    change_pass() {
      ...
      this.$http
        .post(window.location.origin + "/api/change_password", {
    ...
    change_email() {
      ...
      this.$http
        .post(window.location.origin + "/api/change_email", {
          password: this.oldp_email,
          new_email: this.new_email,
          old_email: this.new_email,
        })
        .then((response) => {
          if (!response.data.error) {
            this.oldp_email = "";
