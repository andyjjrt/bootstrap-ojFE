          ...
          <div class="col">
            <div class="form-floating mb-3">
              <input
                ...
                v-model="profile.data.real_name"
              />
...
export default {
  ...
  methods: {
    update_profile() {
      ...
      this.$http
        .put(window.location.origin + "/api/profile", {
